...
public class PrimitiveFieldWrapper<T, ID extends Serializable> extends SimpleAbstractFieldWrapper<T, ID> {

	public PrimitiveFieldWrapper(Field field, EntityWrapper<T, ID> parent, final boolean isNewParent) {
