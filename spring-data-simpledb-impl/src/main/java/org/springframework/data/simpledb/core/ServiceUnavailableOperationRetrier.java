...
public abstract class ServiceUnavailableOperationRetrier {

	public static final int RETRY_TIME = 400;
	...
	public final void executeWithRetries(int serviceUnavailableRetries) {
		try {
	...
	private boolean isServiceUnavailableException(AmazonClientException e) {
		return ( ((AmazonServiceException) e).getErrorType() == AmazonServiceException.ErrorType.Service
				&& ((AmazonServiceException) e).getStatusCode() == ServiceUnavailableOperationRetrier.SERVICE_UNAVAILABLE_STATUS_CODE );
