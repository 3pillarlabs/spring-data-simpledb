...
public class SimpleDbConfigParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        SimpleDbConfig.createInstance(readProperty(element, "accessID"), readProperty(element, "secretKey"), readProperty(element, "domainManagementPolicy"), readProperty(element, "consistent"));
