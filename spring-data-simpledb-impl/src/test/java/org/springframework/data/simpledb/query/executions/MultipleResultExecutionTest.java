...
public class MultipleResultExecutionTest {
    ...
    public void detectResultType_should_return_LIST_OF_LIST_OF_OBJECT() throws Exception{
        ...
        MultipleResultExecution multipleResultExecution = new MultipleResultExecution(null);
        assertEquals(MultipleResultExecution.MultipleResultType.LIST_OF_LIST_OF_OBJECT, multipleResultExecution.detectResultType(repositoryMethod));
    }

    @Test
    public void detectResultType_for_multiple_selected_attributes_should_return_LIST_OF_LIST_OF_OBJECT() throws Exception{
    ...
    public void detectResultType_should_return_LIST_OF_FIELDS() throws Exception{
        ...
        MultipleResultExecution multipleResultExecution = new MultipleResultExecution(null);
        assertEquals(MultipleResultExecution.MultipleResultType.LIST_OF_FIELDS, multipleResultExecution.detectResultType(repositoryMethod));
    }

    @Test
    public void detectResultType_should_return_SET_OF_FIELDS() throws Exception{
        SimpleDbQueryMethod repositoryMethod = prepareQueryMethodToTest("sampleAllSampleListSelectInSet", SampleEntity.class);
        MultipleResultExecution multipleResultExecution = new MultipleResultExecution(null);
